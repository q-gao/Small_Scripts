...
if len(sys.argv) < 5:
    print "USAGE: StudySkewDetection.py <text> <rotation_start> <rotation_end> <rotation_step> [font_name]"
...
for rotate in xrange(int(sys.argv[2]), int(sys.argv[3])+rotateStep, rotateStep):   
    ...
    print rotate,  WidthWithoutLeftRightMargin(hpp)
